...
@section('title', 'Danh sách kích thước Pizza')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Quản Lý Kích Thước Pizza</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.delete-btn').on('click', function(event) {
                        ...
                        if (confirm('Bạn có chắc chắn muốn xóa kích thước Pizza này?')) {
                            deleteAction(id);
                        }
                    });
                },
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Lấy danh sách kích thước Pizza thất bại!', 'Thất Bại');
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Xóa kích thước Pizza thất bại!', 'Thất Bại');
                    }
                }
            });
        }
