...
@section('title', 'Danh sách viền Pizza')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Quản Lý Viền Pizza</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <input id="search-input" class="form-control col-md-2" type="text" placeholder="Tên viền bánh Pizza">
...
<script>
    $(document).ready(function() {
        ...
        function fetchData(page, search = '') {
            $.ajax({
                url: `{{ $api_url }}borders?page=${page}&search=${search}`,
                method: 'GET',
                headers: {
                ...
                success: function(response) {
                    ...
                    response.data.forEach(item => {
                        ...
                        $('tbody').append(`
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.border.update') }}/?id=${item.id}" class="btn btn-primary">Sửa</a>
                    ...
                    $('.delete-btn').on('click', function(event) {
                        ...
                        if (confirm('Bạn có chắc chắn muốn xóa viền bánh Pizza này?')) {
                            deleteAction(id);
                        }
                    });
                },
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Lấy danh sách viền bánh Pizza thất bại!', 'Thất Bại');
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Xóa viền bánh Pizza thất bại!', 'Thất Bại');
                    }
                }
            });
        }
