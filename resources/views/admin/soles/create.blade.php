...
@section('title', 'Thêm đế bánh Pizza')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Thêm Đế Bánh Pizza</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <form id="update-form" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary">Thêm Đế Pizza</button>
                </form>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        if (xhr.status === 401) {
                            ...
                            toastr.error('Thêm đế bánh Pizza thất bại!', 'Thất Bại');
                        }
                    }
                });
            }
